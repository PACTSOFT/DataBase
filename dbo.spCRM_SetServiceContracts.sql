...
SET NOCOUNT ON   
 ...
 BEGIN TRY  
    ...
    DECLARE @Dt FLOAT, @lft bigint,@rgt bigint,@TempGuid nvarchar(50),@Selectedlft bigint,@Selectedrgt bigint,@HasAccess bit,
	@IsDuplicateNameAllowed bit,@IsBOMCodeAutoGen bit  ,@IsIgnoreSpace bit  ,  
  @Depth int,@ParentID bigint,@SelectedIsGroup bit , @XML XML,@ParentCode nvarchar(200),@UpdateSql nvarchar(max),
