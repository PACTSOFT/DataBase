...
--START:FOR START AND END MONTH	
	...
	DECLARE @LEAVETYPEGP INT,@LEAVESTAKEN INT,@CURRYEARALDOCNO BIGINT
	...
	--START:FOR START AND END MONTH	
					...
					DECLARE @UPDATEAL TABLE(InvDocID BIGINT,dcCCNID51 BIGINT,dcCCNID53 BIGINT,dcCCNID52 BIGINT,
