...
if(@TenantID>0)
	...
	BEGIN  
		...
		[CompanyGUID],[GUID],[CreatedBy],[CreatedDate],CCNodeID,CCID,StatusID,AccountID,WorkFlowID,WorkFlowLevel)      
		VALUES (@Code,@FirstName,@Depth,@ParentID,@lft,@rgt,@IsGroup,    
		@CompanyGUID,newid(),@UserName,@Dt,@return_value ,@Dimesion ,@StatusID,@AccReturn_value,@WID,@level)    
