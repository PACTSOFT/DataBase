...
SET NOCOUNT ON;      
 ...
 CREATE TABLE #TBL(ID INT IDENTITY(1,1),NODEID BIGINT,CCID BIGINT)  
 CREATE TABLE #TBLdATA(ID INT IDENTITY(1,1),NODEID BIGINT, PARENTID BIGINT,CCID BIGINT)  
 INSERT INTO #TBL  
 ...
 AND CostCenterId=@CHILDFEATUREID  
 DECLARE @I INT,@COUNT INT,@LOCATION BIGINT,@CCID BIGINT,@SQL NVARCHAR(MAX),@TABLENAME NVARCHAR(MAX)  
 SET @I=1  
