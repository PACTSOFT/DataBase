...
--END
			...
			BEGIN
				DECLARE @TABATTENDANCE TABLE(ID BIGINT IDENTITY(1,1),CHECKINDATE DATETIME,CHECKIN NVARCHAR(15),CHECKINTIME NVARCHAR(50),CHECKOUTDATE DATETIME,CHECKOUT NVARCHAR(15),CHECKOUTTIME NVARCHAR(50),AttendanceType NVARCHAR(25),MonthDate DATETIME,TOTALTIME NVARCHAR(50),InLocDetails nvarchar(max),OutLocDetails nvarchar(max))
			...
			--FOR LEAVES AND LOP
			DECLARE @TABLEAVES TABLE(ID BIGINT IDENTITY(1,1),FROMDATE DATETIME,TODATE DATETIME,LEAVTTYPE NVARCHAR(20))
			--FOR APPLIED LEAVES
