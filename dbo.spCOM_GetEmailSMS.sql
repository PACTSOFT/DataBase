...
BEGIN  
 ...
 begin  
  ...
  N.[From] collate database_default as [From],N.DisplayName,N.[To] collate database_default as [To],N.CC,N.BCC,N.IgnoreMailsTo,N.AttachmentType,N.AttachmentID,N.Subject collate database_default as [Subject],N.Body collate database_default as [Body],N.Query,N.ExtendedQuery,N.FieldsXML,N.UIXML,N.SendReportAs,N.UserWiseDims,N.UserWiseDimsCond  
  ...
  N.[From],N.DisplayName,N.[To],N.CC,N.BCC,N.IgnoreMailsTo,N.AttachmentType,N.AttachmentID,N.Subject,N.Body,N.Query,N.ExtendedQuery,N.FieldsXML,N.UIXML,N.SendReportAs,N.UserWiseDims,N.UserWiseDimsCond  
  ,U.Email1 Login_Email1,U.UserName Login_UserName,U.FirstName Login_FirstName,U.MiddleName Login_MiddleName,U.LastName Login_LastName  
  ...
  E.[From],E.DisplayName,E.[To],E.CC,E.BCC,N.IgnoreMailsTo,E.AttachmentType,E.AttachmentID,E.Subject,E.Body,N.Query Query,N.ExtendedQuery ExtendedQuery,N.FieldsXML,N.UIXML,0 SendReportAs,N.UserWiseDims,N.UserWiseDimsCond  
  ,U.Email1 Login_Email1,U.UserName Login_UserName,U.FirstName Login_FirstName,U.MiddleName Login_MiddleName,U.LastName Login_LastName  
  FROM COM_SchEvents E WITH(nolock)  
