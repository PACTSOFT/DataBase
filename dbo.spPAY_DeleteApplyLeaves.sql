...
DECLARE @FROMDATE DATETIME,@INVDOCID BIGINT,@STATUSID INT,@EMPNODE INT,@LEAVETYPE INT
DECLARE @ICOUNT INT,@RCOUNT INT,@LinkedInvDocDetailsID INT,@DOCUMENTTYPE INT

DECLARE @TAB1 TABLE (ID BIGINT IDENTITY(1,1),INVDOCDETAILSID BIGINT,FROMDATE DATETIME,EMPNODE INT,LEAVETYPE INT)
SET @ICOUNT=1
