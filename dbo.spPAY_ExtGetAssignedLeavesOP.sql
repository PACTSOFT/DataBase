...
WHERE  ID.INVDOCDETAILSID=DC.INVDOCDETAILSID AND ID.INVDOCDETAILSID=DN.INVDOCDETAILSID AND DC.INVDOCDETAILSID=DN.INVDOCDETAILSID AND
	   ...
	   AND ID.COSTCENTERID=40060 AND ID.STATUSID=369 AND
...
WHERE  ID.INVDOCDETAILSID=DC.INVDOCDETAILSID AND ID.INVDOCDETAILSID=DN.INVDOCDETAILSID AND DC.INVDOCDETAILSID=DN.INVDOCDETAILSID AND
	   ID.INVDOCDETAILSID=TD.INVDOCDETAILSID AND ISDATE(TD.DCALPHA3)=1 AND ISDATE(TD.DCALPHA4)=1
	   AND CONVERT(DATETIME,@Date) between CONVERT(DATETIME,TD.DCALPHA3) and CONVERT(DATETIME,TD.DCALPHA4)
	   AND ID.COSTCENTERID=40081 AND ID.STATUSID=369 AND  DC.DCCCNID51=@EmployeeID AND DC.DCCCNID52=@LeaveType
...
BEGIN			
	...
	BEGIN				         
		...
		BEGIN
				...
				WHERE  ISDATE(TD.DCALPHA3)=1 AND ISDATE(TD.DCALPHA4)=1 AND CONVERT(DATETIME,TD.DCALPHA3) BETWEEN CONVERT(DATETIME,@FDYear) AND CONVERT(DATETIME,@TDYear)  AND CC.DCCCNID51=@EmployeeID AND CC.DCCCNID52=@LeaveType AND ID.COSTCENTERID=40081
