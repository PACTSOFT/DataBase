...
(
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid,'Code',2,'Arabic','الرمز','AAC365BB-14C1-4C44-9CB7-E8B16771666B',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+1,'Name',2,'Arabic','الاسم','129416ED-81D7-4BB7-95B9-47C4DFFC841E',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+2,'Status',2,'Arabic','الوضع','476A5A75-31B9-4C6D-8B6A-9E8EB9FB02A6',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+3,'Group',2,'Arabic','المجموعة','A3EAD8BD-1653-431C-B0B3-9911E2154DF3',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+4,'CreditDays',2,'Arabic','ايام الائتمان','AB484A6E-4424-4088-85A3-20BB2225F10A',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+5,'CreditLimit',2,'Arabic','الحد الائتماني','FCE60F19-3B0C-4F63-83F6-3A0AE2DFE6EF',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+6,'PurchaseAccount',2,'Arabic','حساب الشراء','BFBB126E-CD3C-4154-B310-DA8D89231761',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+7,'SalesAccount',2,'Arabic','حساب البيع','EF7C3CC9-F8C1-4D09-A18E-CE783066E110',NULL,'ADMIN',4.076467854000771e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+8,'DebitDays',2,'Arabic','يوم السحب','7EC93F40-74A4-458F-95DD-0EA4CC2FE7EE',NULL,'admin',4.081849413854167e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+9,'DebitLimit',2,'Arabic','حد السحب','F2F87047-1F34-4537-A0B6-CE762478972F',NULL,'admin',4.081849413873457e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+10,'AliasName',2,'Arabic','اسم مستعار','E3B45D14-280D-489D-AD4A-7BA5C2088F4F',NULL,'ADMIN',4.073353878070987e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+11,'GroupSeqNoLength',2,'Arabic','مدة تسلسل المجموعة','66E98DF9-185E-4567-A2E2-0BF7497E3D4C',NULL,'ADMIN',4.073374614907408e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+12,'Group Name',2,'Arabic','اسم المجموعة','2C15CAE9-EE71-4BBA-9F7A-4C11D10B3170',NULL,'ADMIN',4.073155694641203e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+13,'CreatedBy',2,'Arabic','انشئ عن طريق','448BFA36-79E0-4ADF-8C30-AF8A947E86D6',NULL,'ADMIN',4.107153771902006e+004,NULL,NULL,@FeatureName)
	...
	INSERT INTO [Com_LanguageResources] ([ResourceID],[ResourceName],[LanguageID],[LanguageName],[ResourceData],[GUID],[Description],[CreatedBy],[CreatedDate],[ModifiedBy],[ModifiedDate],[FEATURE])VALUES(@Rid+14,'Currency',2,'Arabic','العملة','52525',NULL,'admin',4.022000000000000e+003,NULL,NULL,@FeatureName)
