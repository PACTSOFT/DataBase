...
SET @CustomQuery2=' '
 ...
 SET @SQL='  
	...
	,[Alpha43],[Alpha44],[Alpha45],[Alpha46],[Alpha47],[Alpha48],[Alpha49],[Alpha50]   , isnull(A.ContactID,0) ContactID, A.CreatedBy UserName, convert(datetime,a.CreatedDate) CreatedDate,
