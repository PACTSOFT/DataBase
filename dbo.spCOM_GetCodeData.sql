...
SET NOCOUNT ON;    
	...
	if @IsName=0 and ((@CostCenterID IN (2,3,72,92,93) and @ParentID=1) or (@CostCenterID>50000 and @ParentID=2)) 
...
--	select * from @TblDef
	...
	BEGIN 
		...
		if(@Value is not null and @columnCCID is not null and (@columnccid=2 or @columnccid=3 or @columnccid=11 or @columnccid=72 or @columnccid=92 or @columnccid=93 or @columnccid=44 or (@columnccid>50000 and @columnccid<50057) or @columnccid>50999 ))
		begin
	...
	--	if(@IsParentCodeInherited=1)
		begin
			...
			else if (@CostCenterID>50000 OR @CostCenterID=92 OR @CostCenterID=93)
			begin
