...
END
	...
	BEGIN
		--START: LOADING DATES BASED ON DATERANGE
	   	DECLARE @DATESCOUNT TABLE (SNO BIGINT IDENTITY(1,1),ID BIGINT ,DATE1 DATETIME,DAYNAME VARCHAR(50),WEEKNO INT,COUNT INT)
		...
		DECLARE @DATESAPPLIEDCOUNT TABLE (DOCID BIGINT,DID BIGINT,FDATE DATETIME,TDATE DATETIME,STODATE DATETIME,EODATE DATETIME,ISEDITABLE INT,EXSTLEAVETYPE INT,CURRLEAVETYPE INT,CURDOC INT)
