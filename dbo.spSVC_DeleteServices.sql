...
GO
CREATE PROCEDURE [dbo].[spSVC_DeleteServices]
...
SET NOCOUNT ON;  
		...
		DELETE FROM COM_Files WHERE FeaturePK=@ServiceTypeID and FeatureID=56
		
		--Delete from Main table
		DELETE FROM SVC_ServiceTypes  WHERE ServiceTypeID=@ServiceTypeID
