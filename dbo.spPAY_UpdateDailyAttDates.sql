...
CREATE TABLE #TABEMP(ID BIGINT IDENTITY(1,1),VoucherNo NVARCHAR(600),DocSeqNo NVARCHAR(500),DailyAttDate NVARCHAR(100),UpdStartDate NVARCHAR(500),UpdEndTime NVARCHAR(500),IsUpdate NVARCHAR(100))	
...
WHERE DOCID=@DOCID AND STATUSID=369 AND T.DCALPHA12='YES' AND T.dcAlpha13<>'Absent'
