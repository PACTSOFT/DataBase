...
CREATE TABLE #MONTHTAB (ID BIGINT IDENTITY(1,1),STDATE DATETIME,EDDATE DATETIME)
...
CREATE TABLE #WEEKOFFCOUNT (ID BIGINT ,WEEKDATE DATETIME,DAYNAME VARCHAR(50),WEEKNO INT,COUNT INT)
CREATE TABLE #DATESAPPLIEDCOUNT (FDATE DATETIME,TDATE DATETIME,STODATE DATETIME,EODATE DATETIME,NOOFDAYS DECIMAL(9,2))
create TABLE #DATESCOUNT  (SNO BIGINT IDENTITY(1,1),ID BIGINT ,DATE1 DATETIME,DAYNAME VARCHAR(50),WEEKNO INT,COUNT INT,NOOFDAYS DECIMAL(9,2),FLAG INT,IncExc varchar(5))
SET @MWKOFFS=0
SET @MHDAYS=0 
SET @NOOFHOLIDAYS= 0 
