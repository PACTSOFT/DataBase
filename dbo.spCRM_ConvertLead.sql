...
SET NOCOUNT ON  
	...
	BEGIN  
		...
		VALUES(@ID,86,@LeadID,0,@UserID,0,CONVERT(FLOAT,GETDATE()),@UserName ,@CompanyGUID,0,0,0,0,'','Converted to Opportunity : '+@Code +' - Status: '+@STATUSNAME,'Convert')
		--[CRM_History]
	END  
	...
	BEGIN  
		...
		Begin  
			...
			BEGIN    
				...
				INSERT INTO [CRM_History]([AssignmentID],[CCID],[CCNODEID],[TeamNodeID],USERID,[IsTeam],[CreatedDate],[CreatedBy],[CompanyGUID],IsRole,IsGroup,
				ISFROMACTIVITY,AssignedUserID,AssignedUserName,Description,IsFrom)
				VALUES(@ID,86,@LeadID,0,@UserID,0,CONVERT(FLOAT,GETDATE()),@UserName ,@CompanyGUID,0,0,0,0,'','Converted to Customer : '+@Code +' - Status: '+@STATUSNAME,'Convert')
				--[CRM_History] 
	...
	BEGIN  
		...
		BEGIN    
			...
			INSERT INTO [CRM_History]([AssignmentID],[CCID],[CCNODEID],[TeamNodeID],USERID,[IsTeam],[CreatedDate],[CreatedBy],[CompanyGUID],IsRole,IsGroup,
			ISFROMACTIVITY,AssignedUserID,AssignedUserName,Description,IsFrom)
			VALUES(@ID,86,@LeadID,0,@UserID,0,CONVERT(FLOAT,GETDATE()),@UserName ,@CompanyGUID,0,0,0,0,'','Converted to Contact '+@CompanyName,'Convert')
			--[CRM_History]  
		END  
	END  
		...
		BEGIN       
			...
			BEGIN  
				...
				BEGIN  
					...
					INSERT INTO [CRM_History]([AssignmentID],[CCID],[CCNODEID],[TeamNodeID],USERID,[IsTeam],[CreatedDate],[CreatedBy],[CompanyGUID],IsRole,IsGroup,
					ISFROMACTIVITY,AssignedUserID,AssignedUserName,Description,IsFrom)
					VALUES(@ID,86,@LeadID,0,@UserID,0,CONVERT(FLOAT,GETDATE()),@UserName ,@CompanyGUID,0,0,0,0,'','Converted to Account : '+@Code +' - Status: '+@STATUSNAME,'Convert')
					--[CRM_History]    
