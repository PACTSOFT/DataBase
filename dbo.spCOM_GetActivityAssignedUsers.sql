...
BEGIN
	...
	--EMAIL
		...
		BEGIN
			    ...
			    SELECT UserID FROM CRM_Assignment WITH(NOLOCK) WHERE CCID=@CostCenterID and CCNODEID=@NODEID AND ISFROMACTIVITY=@SUBNodeID
			    ...
			    WHERE CCID=@CostCenterID and CCNODEID=@NODEID AND ISFROMACTIVITY=@SUBNodeID
