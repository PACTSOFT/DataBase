...
BEGIN
SET NOCOUNT ON;
DECLARE @FROMDATE DATETIME,@INVDOCID BIGINT,@MODE INT,@EMPNODE INT,@LEAVETYPE INT,@LEAVESTAKEN FLOAT,@ALStartMonthYear DATETIME,@ALEndMonthYear DATETIME
DECLARE @ICOUNT INT,@RCOUNT INT,@ActualAvailableLeaves FLOAT,@DOCUMENTTYPE INT

DECLARE @TAB2 TABLE (ID BIGINT IDENTITY(1,1),INVDOCDETAILSID BIGINT,FROMDATE DATETIME,EMPNODE INT,LEAVETYPE INT,LEAVESTAKEN FLOAT)
